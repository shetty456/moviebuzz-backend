...
class Auditorium(models.Model):
    ...
    def upcoming_showtimes(self):
        return self.showtime_set.filter(start_time__gte=timezone.now()).order_by('start_time')
...
class BookingHistory(models.Model):  
    ...
    def __str__(self):
        return f"{self.user.username} booked {self.tickets} ticket(s) for {self.showtime}"
    @property
